...
@section('section-view')
    ...
    <div class="card shadow mx-4">
        <div class="card-body">
            <form action="/update-monografi/{{ $produk->produk_id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <div class="col">
                            <select disabled class="form-control chzn-select" multiple="true"id="produk_tema_id"
                    ...
                    <div class="col-md mb-3">
                        ...
                        <input disabled class="form-control" type="text" id="produk_bidanghukum" name="produk_bidanghukum"
                            value="{{ old('produk_bidanghukum', $produk->produk_bidanghukum) }}" placeholder="mis : Hukum Administrasi Negara">
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input disabled class="form-control" type="text" id="produk_deskripsifisik" name="produk_deskripsifisik"
                            value="{{ old('produk_deskripsifisik', $produk->produk_deskripsifisik) }}"
