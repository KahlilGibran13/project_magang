    ...
    <div class="card-body">
        <form action="/update-artikel/{{ $produk->produk_id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea disabled class="form-control" id="produk_judul" rows="2" name="produk_judul" placeholder="Judul Artikel (majalah, koran, dsb)"
                ...
                <div class="card-body text-left">
                    ...
                    <div class="card border-top border-primary shadow mb-3" style="width: 18rem;">
                        ...
                        <div class="card-body text-center">
                            <div class="mb-3">
                                <a href="{{ route('pdf.view', ['filename' => $produk->produk_dokumen]) }}" target="_blank">Lihat</a>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="mb-3">
                        ...
                        @if($produk->produk_dokumen)
                            <p>Dokumen saat ini: <a href="{{ asset('dokumen/' . $produk->produk_dokumen) }}" target="_blank">{{ $produk->produk_dokumen }}</a></p>
                        @endif
            ...
            {{-- can't null --}}
            <input disabled class="form-control" type="text" name="produk_ttd" value="-" hidden>
            <input disabled class="form-control" type="text" name="produk_pemrakarsa" value="-" hidden>
            <input disabled class="form-control" type="text" name="produk_terkait" value="-" hidden>
            <input disabled class="form-control" type="text" name="produk_keyword" value="-" hidden>
            <input disabled class="form-control" type="text" name="produk_abstraks" value="-" hidden>
            <input disabled class="form-control" type="text" name="produk_nomor" value="-" hidden>
            {{-- <input disabled class="form-control" type="text" name="produk_date" value="0000-00-00" hidden> --}}
            <br>
